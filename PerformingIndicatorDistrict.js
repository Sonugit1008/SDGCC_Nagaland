...
class PerformingIndicatorDistrict extends Component {
  constructor(props) {
    super(props);
  ...
  viewDIFScore = () => {
    ...
    apiAuth
      ...
      .then((res) => {
        ...
        data = _.sortBy(data, "diff").slice(0, 5);
  ...
  getRpeotPDf = () => {
    ...
    doc.save("TopIndicatorDistrictReport.pdf");
  };
  ...
  render() {
    return (
      <Fragment>
        <PageHeader
          heading={"Top Indicators(District)"}
          is_filter={true}
                ...
                <>
                  <Colxx lg="1" className="pt-3">
                    <ExportToExcel
                      ...
                      fileName={`DistrictTopIndicatorReport`}
                    />
                  </Colxx>
