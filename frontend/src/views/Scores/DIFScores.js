...
class DIFScores extends Component {
  constructor(props) {
    super(props);
  ...
  getScores = () => {
    let url = "/api/score/view/?type=DIF";

    if (this.state.selectedDistrict) {
      url = url + "&state=" + this.state.selectedDistrict?.value;
    }
    apiAuth
      .get(url)
      .then((response) => {
      ...
      <Fragment>
            ...
            <Card>
              <Row>
                ...
                <Colxx lg="2" className="mb-1">
                  ...
                  {/* {this.state.scores.length ? (
                    <ExportToExcel
                      ...
                      fileName={`${this.state.selectedDistrict?.value} - ScoresData`}
                    />
                  ) : (
                    <></>
                  )} */}
                ...
                <Colxx lg="2" className=" mb-2">
                  <TableExport  fileName={"DistrictScoresData"} />
                </Colxx>
              </Row>
            </Card>
          </Colxx>
        ...
        {this.state.scores.length ? (
          <Fragment>
            ...
            >
              <Modal.Header>
                <Modal.Title>Edit DIF Score</Modal.Title>
                <i
            ...
            >
              <Modal.Header>
                <Modal.Title>Delete DIF Score</Modal.Title>
                <i
                  className="fa fa-close fa-2x cursor-pointer"
                  onClick={() => {
                    this.setState({ deleteModal: false });
...
export default connect(mapStateToProps, mapActionsToProps)(DIFScores);
