...
class CriticalDistricts extends Component {
  constructor(props) {
    super(props);
  ...
  viewDIFScore = () => {
    ...
    apiAuth
      ...
      .then((res) => {
        ...
        data = _.sortBy(data, "value").slice(0, 5);
        ...
        let graphData = {
          ...
          datasets: [
            {
              type: "bar",
              label: `Top 5 critical districts for Goal: ${this.state.selectedGoal?.label}`,
  ...
  getRpeotPDf = () => {
    ...
    doc.save("CriticalDistrictReport.pdf");
  };
  render() {
    return (
      <Fragment>
        <PageHeader
          heading={"Top Critical Districts"}
          is_filter={true}
            ...
            <>
              <Colxx lg="1" className="pt-3">
                <ExportToExcel
                  ...
                  fileName={`CriticalDistrictReport`}
                />
              </Colxx>
...
export default connect(mapStateToProps, mapActionsToProps)(CriticalDistricts);
