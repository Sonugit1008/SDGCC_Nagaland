...
class AspirantIndicator extends Component {
  constructor(props) {
    super(props);
  ...
  viewDIFScore = () => {
    ...
    apiAuth
      .get(
        `/api/public/score/?category=Aspirant&type=${
  ...
  getRpeotPDf = () => {
    ...
    doc.save("AspirantIndicatorReport.pdf");
  };
                ...
                <>
                  <Colxx lg="2" className="pt-3">
                    <ExportToExcel
                      ...
                      fileName={`AspirantIndicatorReport`}
                    />
                  </Colxx>
                  <Colxx lg="2" className="pt-3">
                    <Button
...
export default connect(mapStateToProps, mapActionsToProps)(AspirantIndicator);
