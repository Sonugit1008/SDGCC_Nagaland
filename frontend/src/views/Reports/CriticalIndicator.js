...
class CriticalIndicator extends Component {
  constructor(props) {
    super(props);
  ...
  viewDIFScore = () => {
    ...
    apiAuth
      ...
      .then((res) => {
        ...
        // .filter((dd) =>
        //   this.state.selectedCutoff?.value === 0
        //     ? true
        ...
        data = _.sortBy(data, "diff").reverse().slice(0, 3);
        ...
        let graphData = {
          ...
          datasets: [
            {
              type: "bar",
              label: `Top 5 critical indicators for Goal: ${this.state.selectedGoal?.label}`,
  ...
  getRpeotPDf = () => {
    ...
    doc.save("CriticalIndicatorReport.pdf");
  };
            ...
            <>
              <Colxx lg="1" className="pt-3">
                <ExportToExcel
                  ...
                  fileName={`GoalCriticalIndicatorReport`}
                />
              </Colxx>
...
export default connect(mapStateToProps, mapActionsToProps)(CriticalIndicator);
