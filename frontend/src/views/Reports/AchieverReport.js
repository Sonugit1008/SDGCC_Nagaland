...
class AchieverIndicator extends Component {
  constructor(props) {
    super(props);
  ...
  viewDIFScore = () => {
    ...
    apiAuth
      .get(
        `/api/public/score/?category=Achiever&type=${
  ...
  getRpeotPDf = () => {
    ...
    doc.save("AchieverIndicatorReport.pdf");
  };
                ...
                <>
                  <Colxx lg="1" className="pt-3">
                    <ExportToExcel
                      ...
                      fileName={`AchieverIndicatorReport`}
                    />
                  </Colxx>
...
export default connect(mapStateToProps, mapActionsToProps)(AchieverIndicator);