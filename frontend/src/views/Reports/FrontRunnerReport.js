...
class FrontRunnerIndicator extends Component {
  constructor(props) {
    super(props);
  ...
  viewDIFScore = () => {
    ...
    apiAuth
      .get(
        `/api/public/score/?category=Front Runner&type=${
  ...
  getRpeotPDf = () => {
    ...
    doc.save("FrontRunnerIndicatorReport.pdf");
  };
  ...
  render() {
    return (
      <Fragment>
        <PageHeader
          heading={"Front Runner Indicators"}
          is_filter={true}
                ...
                <>
                  <Colxx lg="1" className="pt-3">
                    <ExportToExcel
                      ...
                      fileName={`FrontRunnerIndicatorReport`}
                    />
                  </Colxx>
