  ...
  getIndicators = (goalsName) => {
    API.get("/api/public/indicator/")
      .then((response) => {
		...
		let difIndicatorDepartment = {};
        let difIndicatorSchema = {};
        data
        ...
        data
          ...
          .forEach((id) => {
			...
			difIndicatorDepartment[id.name] = id.department;
            difIndicatorSchema[id.name] = id.scheme;
          });
        this.setState(
          {
            indicators: data,
                                    ...
                                    <CardBody className="h-100" id="dashchart5">
                                      <Row>
                                        ...
                                        <Colxx className="d-flex justify-content-center">
                                          <h2>
                                            <span className="ml-3 mt-3 font-weight-bold">
                                           {this.state.selDIFIndicatorDist.value} District Indicator scores   for{" "}
                                              {this.state.selectedYear?.label} :{" "}
                                              {this.state.filter}
                                            </span>
                                          </h2>
                                        ...
                                        return (
                                          <>
                                            <Row className="border-bottom my-1 p-1">
                                              <Colxx lg="2" className="font-weight-bold">
											  ...
											  <Colxx lg="2" className=" text-center font-weight-bold">
                                              {this.state.difIndicatorDepartment[
                                                lb
                                              ]
                                                ? this.state
                                                    .difIndicatorDepartment[lb]
                                                : lb}
                                              
                                            </Colxx>
                                           
                                            <Colxx lg="2" className=" text-center font-weight-bold">
                                              {this.state.difIndicatorSchema[
                                                lb
                                              ]
                                                ? this.state
                                                  .difIndicatorSchema[lb]
                                                : lb}
                                            ...
                                            >
                                              {
                                                this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label]?.data
                                                ? this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label]?.data.length > 0
                                                  ? (
                                                      this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] === 100
                                                      ? "Achiever"
                                                      : this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] >= 65 && this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] <= 99
                                                        ? "Front Runner"
                                                        : this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] >= 50 && this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] <= 64
                                                          ? "Performer"
                                                          : this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] >= 0 && this.state.distIndicatorGraphData[this.state.filter][this.state.selDIFIndicatorDist?.label].data[index] <= 49
                                                            ? "Aspirant"
                                                            : ""
                                                    )
                                                  : 0
